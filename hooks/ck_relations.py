...
def install():
    ...
    os.system('sudo tar -xzvf /opt/cloudkitty.tar.gz -C /opt/')
    os.system('sudo tar -xzvf /opt/python-cloudkittyclient.tar.gz -C /opt/')
    ...
    os.system('sudo cp /opt/policy.json /etc/cloudkitty/')
